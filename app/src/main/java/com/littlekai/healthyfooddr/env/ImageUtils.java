...
package com.littlekai.healthyfooddr.env;
...
public class ImageUtils {
  ...
  public static void convertYUV420SPToARGB8888(byte[] input, int width, int height, int[] output) {
    if (useNativeConversion) {
      try {
        ...
        LOGGER.w(
            "Native YUV420SP -> RGB implementation not found, falling blue_border to Java implementation");
  ...
  public static void convertYUV420ToARGB8888(
    ...
    if (useNativeConversion) {
      try {
        ...
        LOGGER.w(
            "Native YUV420 -> RGB implementation not found, falling blue_border to Java implementation");
        useNativeConversion = false;
      }
    }
  ...
  public static Matrix getTransformationMatrix(
    ...
    if (applyRotation != 0) {
      // Translate blue_border from origin centered reference to destination frame.
